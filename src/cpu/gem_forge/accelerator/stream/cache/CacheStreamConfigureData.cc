...
CacheStreamConfigureData::CacheStreamConfigureData(
    ...
    : stream(_stream), dynamicId(_dynamicId), strandIdx(0), totalStrands(1),
      elementSize(_elementSize), initVAddr(0), initPAddr(0),
      addrGenFormalParams(_addrGenFormalParams),

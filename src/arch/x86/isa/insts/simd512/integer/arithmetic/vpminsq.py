...
def macroop VPMINSQ_XMM_XMM {
    mmini dest=xmm0, src1=xmm0v, op2=xmm0m, size=8, ext=Signed
    mmini dest=xmm1, src1=xmm1v, op2=xmm1m, size=8, ext=Signed
};

def macroop VPMINSQ_XMM_M {
    ldfp ufp1, seg, sib, "DISPLACEMENT + 0", dataSize=8
    ldfp ufp2, seg, sib, "DISPLACEMENT + 8", dataSize=8
    mmini dest=xmm0, src1=xmm0v, op2=ufp1, size=8, ext=Signed
    mmini dest=xmm1, src1=xmm1v, op2=ufp2, size=8, ext=Signed
};
...
def macroop VPMINSQ_YMM_YMM {
    mmini dest=xmm0, src1=xmm0v, op2=xmm0m, size=8, ext=Signed
    mmini dest=xmm1, src1=xmm1v, op2=xmm1m, size=8, ext=Signed
    mmini dest=xmm2, src1=xmm2v, op2=xmm2m, size=8, ext=Signed
    mmini dest=xmm3, src1=xmm3v, op2=xmm3m, size=8, ext=Signed
};
...
def macroop VPMINSQ_YMM_M {
    ...
    mmini dest=xmm0, src1=xmm0v, op2=ufp1, size=8, ext=Signed
    mmini dest=xmm1, src1=xmm1v, op2=ufp2, size=8, ext=Signed
    mmini dest=xmm2, src1=xmm2v, op2=ufp3, size=8, ext=Signed
    mmini dest=xmm3, src1=xmm3v, op2=ufp4, size=8, ext=Signed
};
...
def macroop VPMINSQ_ZMM_ZMM {
    ...
    mmini dest=xmm2, src1=xmm2v, op2=xmm2m, size=8, ext=Signed
    mmini dest=xmm3, src1=xmm3v, op2=xmm3m, size=8, ext=Signed
    mmini dest=xmm4, src1=xmm4v, op2=xmm4m, size=8, ext=Signed
    mmini dest=xmm5, src1=xmm5v, op2=xmm5m, size=8, ext=Signed
    mmini dest=xmm6, src1=xmm6v, op2=xmm6m, size=8, ext=Signed
    mmini dest=xmm7, src1=xmm7v, op2=xmm7m, size=8, ext=Signed
};
...
def macroop VPMINSQ_ZMM_M {
    ...
    mmini dest=xmm2, src1=xmm2v, op2=ufp3, size=8, ext=Signed
    mmini dest=xmm3, src1=xmm3v, op2=ufp4, size=8, ext=Signed
    mmini dest=xmm4, src1=xmm4v, op2=ufp5, size=8, ext=Signed
    mmini dest=xmm5, src1=xmm5v, op2=ufp6, size=8, ext=Signed
    mmini dest=xmm6, src1=xmm6v, op2=ufp7, size=8, ext=Signed
    mmini dest=xmm7, src1=xmm7v, op2=ufp8, size=8, ext=Signed
};

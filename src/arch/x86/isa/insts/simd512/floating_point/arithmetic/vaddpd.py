...
def macroop VADDPD_XMM_XMM {
    maddf dest=xmm0, src1=xmm0v, op2=xmm0m, size=8, ext=0
    maddf dest=xmm1, src1=xmm1v, op2=xmm1m, size=8, ext=0
...
def macroop VADDPD_XMM_M {
    ...
    maddf dest=xmm0, src1=xmm0v, op2=ufp1, size=8, ext=0
    maddf dest=xmm1, src1=xmm1v, op2=ufp2, size=8, ext=0
    vclear dest=xmm2, destVL=16
};
...
def macroop VADDPD_YMM_YMM {
    maddf dest=xmm0, src1=xmm0v, op2=xmm0m, size=8, ext=0
    maddf dest=xmm1, src1=xmm1v, op2=xmm1m, size=8, ext=0
    maddf dest=xmm2, src1=xmm2v, op2=xmm2m, size=8, ext=0
    maddf dest=xmm3, src1=xmm3v, op2=xmm3m, size=8, ext=0
...
def macroop VADDPD_YMM_M {
    ...
    maddf dest=xmm0, src1=xmm0v, op2=ufp1, size=8, ext=0
    maddf dest=xmm1, src1=xmm1v, op2=ufp2, size=8, ext=0
    maddf dest=xmm2, src1=xmm2v, op2=ufp3, size=8, ext=0
    maddf dest=xmm3, src1=xmm3v, op2=ufp4, size=8, ext=0
    vclear dest=xmm4, destVL=32
};
...
def macroop VADDPD_ZMM_ZMM {
    ...
    maddf dest=xmm2, src1=xmm2v, op2=xmm2m, size=8, ext=0
    maddf dest=xmm3, src1=xmm3v, op2=xmm3m, size=8, ext=0
    maddf dest=xmm4, src1=xmm4v, op2=xmm4m, size=8, ext=0
    maddf dest=xmm5, src1=xmm5v, op2=xmm5m, size=8, ext=0
    maddf dest=xmm6, src1=xmm6v, op2=xmm6m, size=8, ext=0
    maddf dest=xmm7, src1=xmm7v, op2=xmm7m, size=8, ext=0
};
...
def macroop VADDPD_ZMM_M {
    ...
    maddf dest=xmm2, src1=xmm2v, op2=ufp3, size=8, ext=0
    maddf dest=xmm3, src1=xmm3v, op2=ufp4, size=8, ext=0
    maddf dest=xmm4, src1=xmm4v, op2=ufp5, size=8, ext=0
    maddf dest=xmm5, src1=xmm5v, op2=ufp6, size=8, ext=0
    maddf dest=xmm6, src1=xmm6v, op2=ufp7, size=8, ext=0
    maddf dest=xmm7, src1=xmm7v, op2=ufp8, size=8, ext=0
};

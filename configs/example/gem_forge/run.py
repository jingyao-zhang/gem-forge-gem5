...
parser.add_option("--gem-forge-enable-func-trace", action="store_true",
...
parser.add_option("--gem-forge-stream-engine-enable-o3-elim-stream-end", action="store_true",
...
parser.add_option("--gem-forge-enable-stream-strand-elem-split", type="int",
                  action="store", default="0",
...
parser.add_option("--gem-forge-stream-pum-force-data-type", type="choice",
